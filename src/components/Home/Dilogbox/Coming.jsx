...
export default function DialogDefault() {
  ...
  return (
    <>
     ...
     <h1 className="f-f-b text-3xl lg:text-6xl text-black mt-7 sm:mt-0">COMING SOON!</h1>
...
Your patience is greatly appreciated! <br /><br />

In the meantime, feel free to explore other areas of our platform or reach 
out to us for assistance. We're here to help!<br /><br />
