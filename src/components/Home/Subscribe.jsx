...
export default function Subscribe() {
  return (
    <div>
      <div className="mt-5 h-[2px] w-full bg-green-dark sm:mt-24"></div>
      <div className="bg-grey-vlight py-9">
            ...
            <div className="col-span-12 lg:col-span-8">
              <div className="grid grid-cols-12">
                <div className="col-span-12 sm:col-span-4">
                  <input
                    type="text"
                    className="f-f-r mt-3 h-11 w-full rounded-[50px] border border-green-dark py-4 pl-10 text-base text-grey-dark outline-none sm:mt-0 sm:h-[50px] sm:rounded-none sm:rounded-l-[50px]"
                ...
                <div className="col-span-12 sm:col-span-4">
                  <input
                    type="text"
                    className="f-f-r mt-3 h-11 w-full rounded-[50px] border border-green-dark py-4 pl-10 text-base text-grey-dark outline-none sm:mt-0 sm:h-[50px] sm:rounded-none"
                    placeholder="Enter your name"
                  />
                </div>
                <div className="col-span-12 sm:col-span-4">
