      ...
      <div className="card-body pb-5 text-center">
        <div className="flex justify-between p-2">
          <div className="left-avatar">
            <img src={AvailableAvatar} alt="available-avatar" />
          </div>
          <div>
            <img src={RobotAvatar} alt="robot-avatar" />
          </div>
        </div>
        ...
        <Button className="primary-color mt-3">
          {t("explore.doctors.btnText")}
        </Button>
      </div>
      <div className="primary-color-bg h-[2px] w-full"></div>
      <div className="card-footer flex justify-between bg-white p-3">
        ...
        <div className="flex gap-2">
          ...
          <p className="p-class-card">4 {t("years")}</p>
        </div>
      </div>
    </div>
  );
